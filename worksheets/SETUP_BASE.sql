...
-- Policies to make MFA Optinal
USE ROLE ACCOUNTADMIN
CREATE OR REPLACE AUTHENTICATION POLICY disable_enforce_mfa_policy
 MFA_ENROLLMENT = 'OPTIONAL'
 AUTHENTICATION_METHODS = ('PASSWORD');
ALTER ACCOUNT SET AUTHENTICATION POLICY disable_enforce_mfa_policy;
